...
<link rel= "stylesheet" href ="../website/layout/css/nav.css">
<nav class="navbar" ng-controller="NavController">
    <div class="hidden-xs fb-black">
        <ul class="nav nav-justified">
            <li class="nav-item fb-background-purple">
                <a href="home.html">Home</a>
            </li>
            <li class="nav-item ">
                 <a href="orderCookies.html" class="fb-background-pink">Order Cookies!</a>
            </li>
